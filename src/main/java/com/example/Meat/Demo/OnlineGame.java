...
public class OnlineGame {
    ...
    public void server_turn(Player you, Player opponent, PrintWriter out, BufferedReader in){
        System.out.println("\nTWOJA TURA ");
        //1. przejścia stworów w stronę bazy przeciwnika
        board.move(you, opponent, discarded, cards,  rage_cards, money);
        //wysłanie
        out.println(board.linia2());
        out.println(board.przerywnik());
        out.println(board.linia1());
    }
